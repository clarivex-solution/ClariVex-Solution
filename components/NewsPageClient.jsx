            ...
            <div className="flex items-center gap-2">
              ...
              <CustomSelect
                ...
                options={[
                  ...
                  { value: "US", label: "United States", icon: <img src="/flags/us.svg" alt="US" className="w-5 h-[14px] rounded-[2px] object-cover" /> },
                  { value: "UK", label: "United Kingdom", icon: <img src="/flags/uk.svg" alt="UK" className="w-5 h-[14px] rounded-[2px] object-cover" /> },
                  { value: "AU", label: "Australia", icon: <img src="/flags/au.svg" alt="AU" className="w-5 h-[14px] rounded-[2px] object-cover" /> },
                  { value: "CA", label: "Canada", icon: <img src="/flags/ca.svg" alt="CA" className="w-5 h-[14px] rounded-[2px] object-cover" /> },
