  ...
  return (
    <main className="bg-white text-[#1E293B]">
      <section id="home" className="scroll-mt-28">
        <Hero
          badgeText={heroBadge || `${flag} Dedicated finance support for ${countryName} businesses`}
          heroH1={heroH1}
          heroSub={heroSub}
        />
      </section>
      ...
      <section className="bg-white py-8">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl border border-blue-200 bg-blue-50 p-6 text-sm font-medium text-blue-900">
            {flag} {countryName} Tax Compliance: {taxNote}
          </div>
        </div>
      </section>
