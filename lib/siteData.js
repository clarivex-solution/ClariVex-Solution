...
export const testimonials = [
  {
    ...
    company: "UMPL",
    logo: "/logos/umpl.png",
    text: "ClariVex brought real structure to our financial operations. Monthly reconciliations, compliance tracking, and clean reporting - everything we struggled with internally is now handled with precision. A genuinely reliable finance partner.",
    rating: 5,
  },
  {
    name: "Paresh Mayani",
    role: "Co-Founder & CEO",
    company: "SolGuruz",
    logo: "/logos/solguruz.svg",
    text: "As a fast-moving tech company, we needed a finance team that keeps up. ClariVex does exactly that - proactive, accurate, and always a step ahead on compliance. Our books are clean and our investors have full confidence in our numbers.",
    rating: 5,
  },
  {
    name: "Jvalant Bhai",
    role: "Founder",
    company: "Travel Clues",
    logo: "/logos/travelclues.svg",
    text: "Running a travel business means irregular cash flows and complex GST filings. ClariVex simplified all of it. Their team is responsive, thorough, and genuinely understands the needs of a growing business. Highly recommended.",
    rating: 5,
  },
  {
    name: "Rajesh Mehta",
    role: "Director",
    company: "Zeon Biotech",
    logo: "/logos/zeonbiotech.svg",
    text: "Biotech businesses have layered compliance requirements and ClariVex handles every layer with ease. From vendor payments to regulatory-ready reporting, they've been a dependable extension of our team since day one.",
    rating: 5,
  },
  {
    name: "Nisha Desai",
    role: "Director",
    company: "Oriens Immigration",
    logo: "/logos/oriens.png",
    logoSize: "large",
    text: "ClariVex took complete ownership of our accounts and monthly filings. What used to take us days now happens seamlessly in the background. Their attention to detail and quick turnaround time sets them apart.",
    rating: 5,
  },
  {
    name: "Omkar Joshi",
    ...
    logo: "/logos/omkar.png",
    text: "Construction finances are complex - progress billing, contractor payments, GST on materials. ClariVex manages it all cleanly. Our project accounts are always up to date and audit-ready.",
    rating: 5,
  },
];
...
export const formFieldClassName =
  "w-full rounded-xl border border-[#e2e4e9] px-4 py-3 text-sm text-[#1a1a2e] placeholder:text-[#8892a4] focus:outline-none focus:ring-2 focus:ring-[#6aa595]/30 focus:border-[#6aa595] transition-all duration-200";
