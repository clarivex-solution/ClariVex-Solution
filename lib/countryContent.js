...
const countryContent = {
  us: {
    seo: {
      ...
      ogDescription: "QuickBooks-certified accounting, payroll & tax compliance for American businesses from ClariVex Solution.",
    ...
    compliance: {
      ...
      tools: ["QuickBooks", "Gusto", "ADP", "Expensify"],
    },
    stats: [
    ...
    softwareColumns: [
      { title: "Accounting & ERP", tools: ["QuickBooks", "NetSuite"] },
  ...
  uk: {
    seo: {
      ...
      ogDescription: "Xero-certified bookkeeping, VAT compliance & payroll for British businesses from ClariVex Solution.",
  ...
  au: {
    seo: {
      ...
      ogDescription: "MYOB & Xero bookkeeping, BAS lodgement & payroll for Australian businesses from ClariVex Solution.",
  ...
  ca: {
    seo: {
      ...
      ogDescription: "QuickBooks & Xero bookkeeping, GST/HST compliance & payroll for Canadian businesses from ClariVex Solution.",
    ...
    compliance: {
      ...
      tools: ["QuickBooks", "Xero", "Fathom", "ADP"],
    },
    stats: [
      { value: "15+", label: "Years of Experience" },
    ...
    softwareColumns: [
      { title: "Accounting & ERP", tools: ["QuickBooks", "Xero", "Sage"] },
  ...
  general: {
    seo: {
      title: "ClariVex Solution \u2014 Outsourced Accounting",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "ClariVex Solution — Outsourced Accounting & Finance",
        },
      ],
    },
    twitter: {
