...
const countryContent = {
  us: {
    seo: {
      title: "Outsourced Accounting & Bookkeeping Services USA | ClariVex Solutions",
      description: "Expert outsourced bookkeeping, QuickBooks accounting, payroll processing, and IRS tax compliance for US startups and SMEs. 15+ years experience, 120+ American clients.",
      ogDescription: "QuickBooks-certified accounting, payroll & tax compliance for American businesses. Get a dedicated US finance team from ClariVex Solutions.",
      keywords: "outsourced accounting USA, bookkeeping services America, QuickBooks accountant, US payroll outsourcing, IRS tax compliance, CPA support USA",
  ...
  uk: {
    seo: {
      title: "Outsourced Accounting & Bookkeeping Services UK | ClariVex Solutions",
      description: "Xero-certified outsourced bookkeeping, VAT returns, MTD compliance, and payroll for UK businesses. HMRC-aligned support serving London, Manchester & all UK regions.",
      ogDescription: "Xero-certified bookkeeping, VAT compliance & payroll for British businesses. Trusted by 80+ UK clients for HMRC-aligned finance operations.",
      keywords: "outsourced accounting UK, bookkeeping services London, Xero accountant UK, VAT returns, Making Tax Digital, HMRC compliance",
  ...
  au: {
    seo: {
      title: "Outsourced Accounting & Bookkeeping Services Australia | ClariVex Solutions",
      description: "MYOB & Xero bookkeeping, BAS lodgement, GST compliance, and payroll for Australian businesses. ATO-aligned support with 50+ AU clients.",
      ogDescription: "MYOB & Xero bookkeeping, BAS lodgement & payroll for Australian businesses. ATO-compliant finance operations from ClariVex Solutions.",
      keywords: "outsourced accounting Australia, MYOB bookkeeper, BAS lodgement, Xero Australia, GST compliance, ATO payroll support",
  ...
  ca: {
    seo: {
      title: "Outsourced Accounting & Bookkeeping Services Canada | ClariVex Solutions",
      description: "QuickBooks & Xero bookkeeping, GST/HST filing, CRA compliance, and payroll for Canadian businesses. Serving Toronto, Vancouver & all provinces remotely.",
      ogDescription: "QuickBooks & Xero bookkeeping, GST/HST compliance & payroll for Canadian businesses. CRA-aligned finance operations from ClariVex Solutions.",
      keywords: "outsourced accounting Canada, bookkeeping Toronto, QuickBooks Canada, GST HST filing, CRA compliance, Canadian payroll",
  ...
  general: {
    seo: {
      title: "ClariVex Solutions \u2014 Outsourced Accounting & Finance Operations",
      description: "Elite outsourced accounting, bookkeeping, payroll, and tax compliance for US, UK, AU & CA businesses. 15+ years experience, 280+ active clients worldwide.",
      ogDescription: "Your outsourced accounting partner \u2014 expert bookkeeping, payroll & tax compliance for businesses across the US, UK, Australia & Canada.",
      keywords: "outsourced accounting, bookkeeping services, payroll outsourcing, tax compliance, finance operations, international accounting",
 ...
 * Includes title, description, keywords, canonical, OG tags, and hreflang alternates.
 */
