        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          ...
          <div className="mt-12 grid gap-6 lg:mt-20 lg:grid-cols-2">
            {whyChooseUsCards.map((item) => (
              <article
                key={item.title}
                className="group rounded-xl border border-[#e2e4e9] border-l-4 border-l-[#5a688e] bg-[#f8f9fa] p-8 transition-all hover:border-[#5a688e]/40 hover:shadow-lg"
              >
            ...
            <div className="rounded-2xl border border-[#e2e4e9] bg-white p-10 shadow-lg">
              ...
              <div className="flex flex-wrap gap-2">
                {countryCoverage.map((item) => (
                  <span
                    key={item.label}
                    className="rounded-full border border-[#e2e4e9] bg-[#f8f9fa] px-4 py-2 text-xs text-[#5a6478] transition-colors hover:border-[#5a688e]/50 hover:text-[#1a1a2e]"
                  >
                    {item.label}
                  </span>
                ))}
