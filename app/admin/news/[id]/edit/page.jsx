...
export default function EditNewsPage() {
  ...
  if (fetching) {
    return (
      <div className="p-6 bg-[#f8f9fa] min-h-screen text-[#1a1a2e] flex justify-center items-center">
        <div className="text-[#5a6478] font-medium">Loading...</div>
      </div>
    );
  }
    ...
    <div className="p-6 bg-[#f8f9fa] min-h-screen text-[#1a1a2e]">
      <div className="max-w-3xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold font-playfair">Edit News Article</h1>
          <Link href="/admin/news" className="text-[#5a6478] font-medium hover:text-[#1a1a2e] transition-colors">
            Cancel
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="block text-[#1a1a2e] font-medium text-sm">Slug</label>
