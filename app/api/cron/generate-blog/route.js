...
const TOPICS = [
  // Bookkeeping
  {
    topic: "How to maintain clean books for a small business",
    category: "Bookkeeping",
  },
  {
    topic: "Common bookkeeping mistakes and how to avoid them",
    category: "Bookkeeping",
  },
  { topic: "Chart of accounts setup best practices", category: "Bookkeeping" },
  {
    topic: "Monthly close checklist for small businesses",
    category: "Bookkeeping",
  },
  ...
  {
    topic: "How to handle unreconciled transactions",
    category: "Reconciliation",
  },
  {
    topic: "Credit card reconciliation guide for businesses",
    category: "Reconciliation",
  },

  // AP & AR
  {
    topic: "How to reduce accounts receivable days outstanding",
    category: "AP & AR",
  },
  { topic: "Accounts payable workflow to prevent fraud", category: "AP & AR" },
  { topic: "Invoice management best practices", category: "AP & AR" },
  {
    topic: "How to handle disputed invoices professionally",
    category: "AP & AR",
  },

  // Payroll
  {
    topic: "Payroll compliance checklist for growing businesses",
    category: "Payroll",
  },
  ...
  // Tax Planning
  {
    topic: "Tax planning strategies for small businesses",
    category: "Tax Planning",
  },
  { topic: "How to prepare for a tax audit", category: "Tax Planning" },
  {
    topic: "Common tax deductions businesses overlook",
    category: "Tax Planning",
  },
  ...
  {
    topic: "Key financial KPIs every business owner should track",
    category: "Advisory",
  },
  {
    topic: "When should a business hire an outsourced CFO",
    category: "Advisory",
  },

  // Audit
  {
    topic: "How to prepare your business for an external audit",
    category: "Audit",
  },
  ...
  // Data Security
  {
    topic: "Financial data security best practices for businesses",
    category: "Data Security",
  },
  {
    topic: "How to protect sensitive financial information",
    category: "Data Security",
  },
];
...
export async function GET(request) {
  ...
  try {
    ...
    const countryContext = {
      ...
      General:
        "targeting international businesses across US, UK, Australia, and Canada",
    };
